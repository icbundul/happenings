package com.nativehappenings.happenings.security;

import com.nativehappenings.happenings.security.jwt.AuthEntryPointJwt;
import com.nativehappenings.happenings.security.jwt.AuthTokenFilter;
import com.nativehappenings.happenings.services.impl.UserDetailsServiceImpl;
...
/* @EnableWebSecurity allows Spring to find and automatically apply the class to the global Web Security.
   ...
   It enables @PreAuthorize, @PostAuthorize, it also supports JSR-250. You can find more parameters in configuration
   in Method Security Expressions.
